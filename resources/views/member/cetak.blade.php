...
<body>
    @foreach ($datamember as $key => $data)
        @foreach ($data as $item)
            <div class="logos">
                <img style="aspect-ratio: 425/139; width: 300px;" src="{{ public_path($setting->path_logo) }}"
                    alt="logo">
            </div>
            <img style="position:absolute; inset:0;" src="{{ public_path($setting->path_kartu_member) }}" alt="card"
                width="100%">
            <div class="inside">
